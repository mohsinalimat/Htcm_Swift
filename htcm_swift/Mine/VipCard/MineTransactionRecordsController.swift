//
//  MineTransactionRecordsController.swift
//  htcm_swift
//
...
class MineTransactionRecordsController: BaseController ,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        self.setNavgaionTitle(string: "交易记录")
