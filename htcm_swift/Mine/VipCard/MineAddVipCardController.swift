//
//  MineAddVipCardController.swift
//  htcm_swift
//
...
class MineAddVipCardController: BaseController ,UITableViewDelegate,UITableViewDataSource,AccountViewsDelegate{
    ...
    override func viewDidLoad() {
        ...
        self.setNavgaionTitle(string: "添加健康卡")
    ...
    func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        ...
        footer.vipCardDic = NSDictionary.init()
        return footer
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.vipCardDic = NSDictionary.init()
        return cell
