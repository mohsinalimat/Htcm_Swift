...
extension LLCycleScrollView{
    ...
    override func layoutSubviews() {
        ...
        if mainView?.contentOffset.x == 0 && totalItemsCount != 0 {
            ...
            mainView?.scrollToItem(at: IndexPath.init(row: targetIndex, section: 0), at: UICollectionView.ScrollPosition(rawValue: 0), animated: false)
        }
        ...
        pageControl?.frame = CGRect.init(x: x, y: y-10, width: (size?.width)!, height: (size?.height)!)
    }
    ...
    @objc fileprivate func automaticScroll() {
        ...
        if targetIndex == totalItemsCount {
            ...
            mainView?.scrollToItem(at: NSIndexPath.init(row: targetIndex, section: 0) as IndexPath, at: UICollectionView.ScrollPosition(rawValue: 0), animated: false)
        }
        mainView?.scrollToItem(at: NSIndexPath.init(row: targetIndex, section: 0) as IndexPath, at: UICollectionView.ScrollPosition(rawValue: 0), animated: true)
    }
